...
if($div_dir == "page") {
	...
	switch ($sub_dir) {
		...
		case "s1" :
			...
			// 디렉토리 내 페이지 별 데이터 설정
			switch ($now_page) {
				//case "s1.php" : $page_name="ARIM RA-100";			$b_num="1";		$c_num=""; break;
				case "s1.php" : $page_name="ARIM RA-200";			$b_num="1";		$c_num=""; break;
				case "s2.php" : $page_name="ARIM RA-300";			$b_num="2";		$c_num=""; break;
				case "s3.php" : $page_name="ARIM OA-100";			$b_num="3";		$c_num=""; break;
				case "s4.php" : $page_name="ARIM OA-200";			$b_num="4";		$c_num=""; break;
		...
		//	$section_name = "SOLUTION";
			...
			// 디렉토리 내 페이지 별 데이터 설정
		//	switch ($now_page) {
		//		case "s1.php" : $page_name="SOLUTION";			$b_num="1";		$c_num=""; break;
		//	}
		//break;
		...
		case "s2" :
			...
			// 디렉토리 내 페이지 별 데이터 설정
			switch ($now_page) {
				case "s1.php" : $page_name="SERVICE";			$b_num="1";		$c_num=""; break;
			}
		break;

		case "s3" :
			$a_num = "3";
			$section_name = "ARIM SCIENCE";

			// 디렉토리 내 페이지 별 데이터 설정
			switch ($now_page) {
				case "s1.php" : $page_name="ABOUT ARIM SCIENCE";			$b_num="1";		$c_num=""; break;
				case "s2.php" : $page_name="COMPANY HISTORY";			$b_num="2";		$c_num=""; break;
				case "s3.php" : $page_name="CONTACT US";			$b_num="3";		$c_num=""; break;
			}
		break;
		...
		case "s4" :
			...
			// 디렉토리 내 페이지 별 데이터 설정
			switch ($now_page) {
				case "s1.php" : $page_name="NOTICE";			$b_num="1";		$c_num=""; break;
				case "s2.php" : $page_name="FAQ";			$b_num="2";		$c_num=""; break;
			}
		break;
