<?php /* Template_ 2.2.8 2023/07/19 01:11:23 /www_root/app/rtmember/template/rtmember.find.html 000002689 */ ?>
<!-- 반응형 회원 시작 -->
	...
	<form name="findpw_form" method="post" target="rt_ifrm">
		<div class="rt-rwd-login-wrap">
			<div class="rt-rwd-login-con">
				...
				<div class="rt-rwd-login-box">
					<input type="text" placeholder="아이디(이메일)" id="findpw_id" />
				</div>
				<!-- <div class="rt-rwd-login-box">
...
<!-- 반응형 회원 끝 -->
<script src="<?php echo $TPL_VAR["path_assets"]?>/js/rtmember.find.js?ver=<?php echo $TPL_VAR["캐시버전"]?>" type="text/javascript"></script>
