<?php /* Template_ 2.2.8 2017/03/11 00:47:03 /home/rintkit.com/new/app/rtboard/template/info.layout.gallery.list.responsive.html 000005084 */ 
...
<?php if($TPL_리스트_1){foreach($TPL_VAR["리스트"] as $TPL_V1){?>
			<div class="rt-rwd-photo-con">
				...
				<div class="rt-rwd-photo-substance">
					<p class="rt-rwd-photo-subject"><a href="<?php echo $TPL_V1["상세페이지링크"]?>"><?php if($TPL_VAR["분류사용"]=='y'&&$TPL_V1["분류"]){?>[<?php echo $TPL_V1["분류"]?>]<?php }?><?php echo $TPL_V1["줄임제목"]?>&nbsp;<?php if($TPL_VAR["댓글사용"]=='y'&&$TPL_V1["댓글수"]> 0){?>[<?php echo $TPL_V1["댓글수"]?>]<?php }?></a></p>
