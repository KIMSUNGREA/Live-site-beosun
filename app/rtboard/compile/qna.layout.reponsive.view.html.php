<?php /* Template_ 2.2.8 2017/03/11 00:47:03 /www_root/app/rtboard/template/qna.layout.reponsive.view.html 000010805 */ 
...
<?php if($TPL_VAR["포스트"]["답글여부"]=='y'&&$TPL_VAR["포스트"]["공지여부"]=='n'){?>
		<div class="rt-rwd-view-body">
			<p>| 답글</p>
			<p><?php echo $TPL_VAR["포스트"]["답글내용"]?></p>
		</div>
<?php }?>
...
<?php if($TPL_VAR["포스트"]["답글여부"]=='y'){?>
			<a href="javascript:alert('답글이 달린 글은 수정할 수 없습니다');">수정</a>
<?php }else{?>
			<a href="<?php echo $TPL_VAR["수정페이지링크"]?>">수정</a>
<?php }?>
<?php }?>
	</div>
	<!-- 버튼 끝 -->
...
<form name="cmt_use_form" method="post" action="<?php echo $TPL_VAR["acturl"]?>/user/update.php" target="rt_ifrm">
