...
if( !class_exists("rtboard_info") )
{
	class rtboard_info extends board
	{
		//----------------------------------------------------------------------------------------------
		...
		*/
		...
		function rtboard_info($ai_page_num=10, $ai_page_block=10)
		{
			$this->board("RT_RTBOARD_INFO", $ai_page_num, $ai_page_block);
		}
