<div id="aside">
	...
	<ul class="rt_aside_wrap">
		...
		<li class="rt_aside_depth1_wrap <?php echo $__lnb_app_rtmember_on;?>">
			...
			<div class="rt_aside_depth2_wrap">
				<a href="<?php echo RTW_ADM;?>/app/?appcode=rtmember&sd=admin-data" class="rt_aside_depth2 rt_font_s <?php echo $__lnb_app_rtmember_admin_data_on;?>">
					<span class="rt_aside_depth2_txt"><span class="rt_dot"></span>회원 관리</span>
				</a>
		...
		<li class="rt_aside_depth1_wrap <?php echo $__lnb_review_on;?>">
			<a href="<?php echo RTW_ADM;?>/review/?sd=post&cf=list" class="rt_aside_s"></a>
			<a href="<?php echo RTW_ADM;?>/review/?sd=post&cf=list" class="rt_aside_depth1 rt_font <?php echo $__lnb_review_post_on;?>">완주후기
				<span class="rt_aside_ico"><img src="<?php echo RTW_LAYOUT;?>/images/common/aside_page.png" alt="아이콘" /></span>
			</a>
		</li>
		<?php if ($cls_adm->auth_code == "master") { ?>
